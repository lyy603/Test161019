...
/**
 * 作者：linyaye on 2016/12/20 12:28
 */
...
public class DefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private DefaultHeader.LastUpdateTimeUpdater mLastUpdateTimeUpdater = new DefaultHeader.LastUpdateTimeUpdater();
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.article_comment_list_header, this);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.pull_down_to_refresh));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.pull_down));
        }
    }
    ...
    private String getLastUpdateTime() {
        ...
        if (seconds < 60) {
            sb.append(seconds + getContext().getString(R.string.seconds_ago));
        } else {
            ...
            if (minutes > 60) {
                ...
                if (hours > 24) {
                    ...
                    sb.append(hours + getContext().getString(R.string.hours_ago));
                }

            } else {
                sb.append(minutes + getContext().getString(R.string.minutes_ago));
            }
        }
        return sb.toString();
    }
