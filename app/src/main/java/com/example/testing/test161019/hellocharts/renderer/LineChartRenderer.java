package com.example.testing.test161019.hellocharts.renderer;
...
import com.example.testing.test161019.hellocharts.view.Chart;
...
public class LineChartRenderer extends AbstractChartRenderer {
    ...
    private void drawTestPath(Canvas canvas) {
        ...
        List<Line> line = dataProvider.getLineChartData().getLines();
        List<PointValue> pointValue = line.get(0).getValues();
        final float rawX = computator.computeRawX(pointValue.get(0).getX());
        final float rawX2 = computator.computeRawX(pointValue.get(pointValue.size() - 1).getX());
